...
if ($user_status_t->num_rows > 0) {
    ...
    if ($result_1->num_rows >= 7) {
        ...
        if ($time_end_5 > $created_time_5) {
            ...
            $url = "https://smsc.txtnation.com:8093/sms/send_sms.php?dst=$dest&msg=Your%20Timebucks%20OTP%20:%20$digit&dr=0&type=0&src=Timebucks&user=timebucks&password=jninXiV9";
